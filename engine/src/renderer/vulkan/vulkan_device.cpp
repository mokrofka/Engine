...
internal b8 select_physical_device(VulkanContext* context);
internal b8 physical_device_meets_requirements(
    VkPhysicalDevice device, VulkanContext* context,
...
internal b8 physical_device_meets_requirements(
  ...
  if (
    ...
    vulkan_device_query_swapchain_support(device, context, out_swapchain_support);
