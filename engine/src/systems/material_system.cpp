...
void load_material(MaterialConfig config, Material* m);
void destroy_material(Material* m);
void load_configuration_file(char* path, MaterialConfig* out_config);

// void material_system_initialize(Arena* arena, MaterialSystemConfig config) {
