...
//   FileProperties props = os_properties_from_file_path(app->lib_filepath);
//   app->modified = props.modified;
//   os_copy_file_path(app->lib_temp_filepath, app->lib_filepath);
...
// internal void load_game_lib_init(App* app) {
//   FileProperties file_props = os_properties_from_file_path(app->lib_filepath);
...
//   app->lib_filepath = push_str_cat(st.arena, file_directory, "game.dll");
//   app->lib_temp_filepath = push_str_cat(st.arena, file_directory, "game_temp.dll");
